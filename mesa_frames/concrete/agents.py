...
class AgentsDF(AgentContainer):
    ...
    def __isub__(self, agents: AgentSetDF | Iterable[AgentSetDF] | IdsLike | DataFrame) -> Self:
    ...
    def __sub__(self, agents: AgentSetDF | Iterable[AgentSetDF] | IdsLike | DataFrame) -> Self:
