...
@pytest.fixture
def fix1_AgentSetPandas() -> ExampleAgentSet:
    model = ModelDF()
    agents = ExampleAgentSet(model, pd.Index([0, 1, 2, 3], name="unique_id"))
...
@pytest.fixture
def fix2_AgentSetPandas() -> ExampleAgentSet:
    model = ModelDF()
    agents = ExampleAgentSet(model, pd.Index([4, 5, 6, 7], name="unique_id"))
...
class Test_AgentSetPandas:
    def test__init__(self):
        model = ModelDF()
        agents = ExampleAgentSet(model, pd.Index([0, 1, 2, 3]))
    ...
    def test_add(
        self, fix1_AgentSetPandas: ExampleAgentSet, fix2_AgentSetPandas: ExampleAgentSet
    ):
    ...
    def test_contains(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_copy(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_discard(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_remove(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        agents.remove([0, 1])
    ...
    def test_set(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_shuffle(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        for _ in range(10):
    ...
    def test_sort(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test__contains__(self, fix1_AgentSetPandas: ExampleAgentSet):
        # Test with a single value
        agents = fix1_AgentSetPandas
        assert 0 in agents
        assert 4 not in agents

    def test__copy__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        agents.test_list = [[1, 2, 3]]
    ...
    def test__deepcopy__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        agents.test_list = [[1, 2, 3]]
    ...
    def test__getattr__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        assert isinstance(agents.model, ModelDF)
        assert agents.wealth.tolist() == [1, 2, 3, 4]

    def test__getitem__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test__iter__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test__len__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        assert len(agents) == 4
    ...
    def test__reversed__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
        reversed_wealth = []
    ...
    def test__setitem__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test__str__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents: ExampleAgentSet = fix1_AgentSetPandas
        str(agents)

    def test__sub__(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents: ExampleAgentSet = fix1_AgentSetPandas
        agents2: ExampleAgentSet = agents - agents.agents
        assert agents2.agents.empty
        assert agents.agents.wealth.tolist() == [1, 2, 3, 4]

    def test_get_obj(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_active_agents(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
    ...
    def test_inactive_agents(self, fix1_AgentSetPandas: ExampleAgentSet):
        agents = fix1_AgentSetPandas
